...
describe('Input', () => {
  ...
  it('renders with controlled value', () => {
    render(<Input {...defaultProps} value="Controlled text" onChange={vi.fn()} />);
  ...
  it('renders different input types', () => {
    ...
    input = screen.getByLabelText('password') || screen.getByDisplayValue('');
  ...
  it('renders help text when provided', () => {
    render(<Input {...defaultProps} helpText="Enter your email address" />);
